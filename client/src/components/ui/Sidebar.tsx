...
import {
    LayoutDashboard, Code2, FileText,
    Mic, LogOut, User, Settings
} from 'lucide-react'
            ...
            <div className="px-3 py-4 border-t border-[#1E1E2E] space-y-0.5">
                <NavLink
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm
                     font-medium text-[#9090A8] hover:text-[#F1F1F5]
                     hover:bg-[#22222F] transition-all duration-150"
                >
                    <Settings size={16} />
                    Settings
                </NavLink>
                ...
                <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl
                     text-sm font-medium text-[#9090A8] hover:text-[#EF4444]
                     hover:bg-[#EF444415] transition-all duration-150 cursor-pointer"
                >
                    <LogOut size={16} />
                    Logout
                </button>
                ...
                <div className="flex items-center gap-3 px-3 py-3 mt-2
                        bg-[#1A1A24] rounded-xl border border-[#1E1E2E]">
                    <div className="w-7 h-7 rounded-full bg-[#6366F120] border border-[#6366F130]
