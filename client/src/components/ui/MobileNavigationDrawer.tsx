...
export const MobileNavigationDrawer = ({ open, onClose }: MobileNavigationDrawerProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[70] lg:hidden">
            ...
            <section role="dialog" aria-modal="true" aria-label="Application navigation" className="drawer-panel absolute inset-y-0 left-0 flex w-[min(88vw,22rem)] flex-col border-r border-border bg-bg-secondary shadow-2xl">
                ...
                <nav aria-label="Mobile navigation" className="min-h-0 flex-1 space-y-1 overflow-y-auto px-3 py-4">
                ...
                <div className="app-safe-bottom border-t border-border px-3 py-4">
