...
export const AudioInterviewUploader = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { data } = await interviewService.uploadAudio(formData);
            ...
            setError(
                ...
                "Failed to upload and analyze audio interview."
            );
        } finally {
            setUploading(false);
        }
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            <section className="bg-bg-secondary border border-border rounded-2xl p-5">
                <div className="flex items-center gap-2 mb-4">
                    <FileAudio size={17} className="text-brand" />
                ...
                <p className="text-sm text-text-secondary leading-6 mb-5">
                    Upload a mock or real interview audio. PlacementOS will transcribe it,
                    analyze weak concepts, generate scores, and save the replay.
                </p>
                ...
                <div className="mt-3 border border-dashed border-border hover:border-brand rounded-2xl p-6 bg-bg-tertiary transition">
                    ...
                    >
                        ...
                        <p className="text-xs text-text-tertiary mt-1">
                            MP3, WAV, M4A, WEBM, or OGG up to 50MB
                        </p>
                    </label>
                </div>
            </section>
